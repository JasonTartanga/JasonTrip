...
public class Inicio extends javax.swing.JDialog {
     ...
     */
    public Inicio(VMain vMain, boolean modal, DAO dao, Usuario usu) {
        super(vMain, modal);
        this.vMain = vMain;
        this.dao = dao;
        this.usu = usu;
        ...
        panelSlide.init(new P_Inicio(dao, usu), new P_Listas(vMain, dao, usu), new P_Dia(dao, usu), new P_Cuenta(dao, usu));
    ...
    private void initComponents() {
        ...
        panelSlide.setBackground(new java.awt.Color(21, 21, 21));
